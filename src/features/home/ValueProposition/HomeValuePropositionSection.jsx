...
function HomeValuePropositionSection() {
  const values = [
    ...
    {
      title: "Lada, loft och ateljé",
      description: "Lokaler för kurser, evenemang, utställningar och fester",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <section className="value-proposition-section" aria-labelledby="value-props-heading">
      <div className="value-proposition-container">
        <h2 id="value-props-heading" className="sr-only">Kort om Storegården 7</h2>
